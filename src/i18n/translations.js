const t = {
  es: {
    ...
    about: {
      eyebrow: "Sobre mí",
      title: "Lo que aporto a un proyecto",
      intro:
    ...
    skills: {
      ...
      subtitle:
        "Herramientas con las que desarrollo interfaces, prototipos y proyectos visualmente cuidados.",
    },
    ...
    projects: {
      ...
      title: "Proyectos",
      intro:
        "Podés recorrer mis trabajos con flechas y abrir cada proyecto para ver su detalle completo.",
      ...
      descriptions: {
        ...
        "Tienda de Café":
          "E-commerce simple de café con filtros y búsqueda de productos orientado a una navegación clara.",
        "Tienda de Bebidas":
          "Catálogo de bebidas con cards y detalle de producto, desarrollado con Sass y pensado para una estética más comercial.",
        "Tienda Safaris":
          "Catálogo visual de safaris con cards y detalle de producto, diseñado para una navegación simple y atractiva.",
      },
    },
  ...
  en: {
    ...
    focusAreas: {
      ...
      intro:
        "I want visitors to quickly understand that I work in both web development and video editing. Both areas are part of my profile and what I offer as a freelancer.",
    ...
    about: {
      ...
      cards: [
        {
          title: "Frontend",
          text: "I develop clear, neat and responsive interfaces focused on a good visual experience.",
        },
        {
          title: "UI Design",
          text: "I care about each website visually communicating a brand, project or product more effectively.",
        },
        {
          title: "Freelance",
          text: "I look to work on projects where I can contribute design, structure and a more professional presentation.",
        },
      ],
    ...
    skills: {
      ...
      subtitle:
        "Tools I use to develop interfaces, prototypes and visually polished projects.",
    },
    ...
    projects: {
      ...
      title: "Projects",
      intro:
        "Browse my work with the arrows and open each project to see its full detail.",
      ...
      descriptions: {
        ...
        "Tienda Skincare":
          "Skin quiz and product recommendation with a simple, clear visual experience focused on navigation.",
        "Tienda de Café":
          "Simple coffee e-commerce with product filters and search, focused on clear navigation.",
        "Tienda de Bebidas":
          "Beverage catalog with cards and product detail, built with Sass and designed for a more commercial aesthetic.",
        "Tienda Safaris":
          "Visual safari catalog with cards and product detail, designed for simple and attractive navigation.",
      },
    },
    ...
    contact: {
      ...
      intro:
        "If you have an idea, brand or project to showcase, write to me here. I work in both web development and video editing.",
      labelName: "Name",
